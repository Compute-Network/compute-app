...
fn build_chat_completion_body(
    ...
    json!({
        ...
        "gateway_timings": {
            ...
            "prompt_tokens": result.completion.timings.prompt_tokens,
            "decode_steps": result.completion.timings.decode_steps,
            "total_transfer_bytes": result.completion.timings.total_transfer_bytes,
            "head_hidden_bytes_prefill": result.completion.timings.head_hidden_bytes_prefill,
            "head_hidden_bytes_decode": result.completion.timings.head_hidden_bytes_decode,
            "head_pack_ms": result.completion.timings.head_pack_ms,
            "tail_unpack_ms": result.completion.timings.tail_unpack_ms,
            "stage_request_json_encode_ms": result.completion.timings.stage_request_json_encode_ms,
            "stage_response_json_decode_ms": result.completion.timings.stage_response_json_decode_ms,
            "stage_request_write_ms": result.completion.timings.stage_request_write_ms,
            "stage_response_read_ms": result.completion.timings.stage_response_read_ms,
            "stage_server_request_json_decode_ms": result.completion.timings.stage_server_request_json_decode_ms,
            "stage_server_handle_ms": result.completion.timings.stage_server_handle_ms,
            "stage_server_response_json_encode_ms": result.completion.timings.stage_server_response_json_encode_ms,
            "stage_server_response_write_ms": result.completion.timings.stage_server_response_write_ms,
            "inline_sample_hits": result.completion.timings.inline_sample_hits,
            "sample_rpc_fallbacks": result.completion.timings.sample_rpc_fallbacks,
            ...
            "spec_draft_ms": result.completion.timings.spec_draft_ms,
            "spec_verify_ms": result.completion.timings.spec_verify_ms,
            "spec_rollback_ms": result.completion.timings.spec_rollback_ms,
        }
    })
}
